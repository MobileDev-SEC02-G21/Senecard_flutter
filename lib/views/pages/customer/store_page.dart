...
class StorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<MainPageViewmodel>(
      ...
      final storesViewmodel =
          StoresPageViewmodel(stores: mainViewModel.stores);

      final storeElements = storesViewmodel.getStores();
      final Widget categories = storesViewmodel.getCategories(mainViewModel.stores);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              : StoreList(displayItems: storeElements, shorter: false,),
              const SizedBox(height: 10),
            ],
          ),
        ),
