...
class AdsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<MainPageViewmodel>(
      ...
      final adsViewmodel = AdsPageViewmodel(
          stores: mainViewModel.stores, ads: mainViewModel.advertisements);

      final adsElements = adsViewmodel.getAdvertisements();
      final Widget categories = adsViewmodel.getCategories(mainViewModel.stores);
